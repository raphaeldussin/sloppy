...
def test_polarstereo_to_mom6_brute(topofile, gridfile):
    ...
    #plt.figure()
    #plt.pcolormesh(elev1[0,:,:]) ; plt.colorbar()
    #plt.figure()
    #plt.pcolormesh(elev2[0,:,:]) ; plt.colorbar()
    #plt.figure()
    #plt.pcolormesh(elev2[0,:,:] -elev1[0,:,:]) ; plt.colorbar()
    #plt.show()
...
def test_regular_to_mom6global_optim(topofile, gridfile):
    ...
    #import matplotlib.pyplot as plt
    #plt.figure()
    #plt.pcolormesh(elev[0,:,:], vmin=-5000, vmax=5000) ; plt.colorbar()
    #plt.show()
