...
bedmachine = xr.open_dataset("/media/raphael/L2/topography/BedMachineAntarctica_2020-07-15_v02.nc")
...
lon_model, lat_model = np.meshgrid(
    ...
    np.linspace(-180, 180, 181), np.linspace(-90, -60, 16)
)
...
plt.figure() ; plt.pcolormesh(out[:,:,0], vmax=-60) ; plt.colorbar() ; plt.show()
